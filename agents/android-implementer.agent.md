...
The typed role contract is `manifests/agent-contracts.json` → `android-implementer`. Native work is constrained by the unified release train and the Journey hybrid boundary.
